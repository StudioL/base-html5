...
<div id="menu">
<a href="core.salir.php">cerrar sesión</a>
</div>
<h2>Login</h2>
...
<div id="contenido">
        ...
        <div style="border: 2px solid red;color: red; padding: 30px; margin-left: 100px; margin-right:100px;text-align: center;">usuario o contraseña incorrectos</div>
        <? } ?>

        <form action="core.control.php" method="post">
        <div>
        <label>usuario<br />
        <input type="text" name="usuario" id="usuario" /></label><br />
        <label>contraseña<br />
